          ...
          <Container fluid>
            <div>
              <Breadcrumb tag="nav" listTag="div">
                ...
                <BreadcrumbItem tag="a" href="/settlements">
                  All Settlements
                </BreadcrumbItem>
                <BreadcrumbItem
                  tag="a"
                  ...
                  style={{ color: "#ffffff" }}
                >
                  Settlement Id : Setl_foB8deixfgGjLj
                </BreadcrumbItem>
              </Breadcrumb>
            </div>
          </Container>
