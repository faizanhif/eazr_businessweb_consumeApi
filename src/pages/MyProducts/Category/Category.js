        ...
        <div className="page-content transaction-page">
          ...
          <div className="category-page mt-4">
            ...
            <div className="category-products d-flex">
              <MainCategory img={Category1} name="Medicine" amount="12,567" />
              <MainCategory
                img={Category2}
                name="Personal Care"
                amount="12,567"
              />
              <MainCategory img={Category3} name="Suppliments" amount="3,500" />
              <MainCategory img={Category4} name="Equipments" amount="6,750" />
            </div>
